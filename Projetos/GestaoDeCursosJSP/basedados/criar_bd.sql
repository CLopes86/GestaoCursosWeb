...
INSERT INTO Perfis (Descricao) VALUES ('Administrador'), ('Docente'), ('Aluno'), ('Visitante');

-- Insere três usuários de exemplo nas tabelas 'Usuarios', cada um com um perfil específico
INSERT INTO Usuarios (Email, Senha, Nome, DataCadastro, PerfilID)
VALUES
('admin@admin.com', MD5('admin'), 'Administrador', CURDATE(), (SELECT PerfilID FROM Perfis WHERE Descricao = 'Administrador')),
('docente@docente.com', MD5('docente'), 'Docente', CURDATE(), (SELECT PerfilID FROM Perfis WHERE Descricao = 'Docente')),
('aluno@aluno.com', MD5('aluno'), 'Aluno', CURDATE(), (SELECT PerfilID FROM Perfis WHERE Descricao = 'Aluno'));
('visitante@exemplo.com', MD5('visitante'), 'Usuário Visitante', CURDATE(), (SELECT PerfilID FROM Perfis WHERE Descricao = 'Visitante'));
